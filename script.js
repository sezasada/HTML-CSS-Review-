...
function displayRevenue() {
  ...
  let peRatio = 21.5358;
    ...
    // created values for revenue and peRatio
  ...
  row.appendChild(guidanceCell);
    ...
    // created cell for coppany guidance
